...
from LAVIS.lavis.models.ulip_models import losses
...
def ULIP_PointBERT(ulip_v=2):
    ...
    from LAVIS.lavis.models.ulip_models.pointbert.point_encoder import PointTransformer
    from LAVIS.lavis.models.ulip_models.utils.config import cfg_from_yaml_file
