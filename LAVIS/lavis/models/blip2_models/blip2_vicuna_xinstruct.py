...
from LAVIS.lavis.models.blip2_models.blip2 import Blip2Base, disabled_train, LayerNorm
from LAVIS.lavis.models.ulip_models.ULIP_models import ULIP_PointBERT
from LAVIS.lavis.tasks.multimodal_classification import MultimodalClassificationTask

from LAVIS.lavis.common.utils import is_url
from LAVIS.lavis.models.blip2_models.Qformer import BertConfig, BertLMHeadModel
from LAVIS.lavis.common.dist_utils import download_cached_file
from LAVIS.lavis.processors.blip_processors import BlipCaptionProcessor
...
class Blip2VicunaXInstruct(Blip2Base):
    ...
    def init_audio_encoder(
        ...
        if "beats" in model_name:
            from LAVIS.lavis.models.beats_encoder import BeatsEncoder
