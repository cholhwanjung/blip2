...
if __name__ == "__main__":
    ...
    wandb_project = "BLIP-2 Q Finetuning v3"
    run_name = "test"
    ...
    ## init model
    checkpoint_path = "Salesforce/blip2-itm-vit-g"

    model = Blip2ForImageTextRetrieval.from_pretrained(checkpoint_path,
        device_map = "auto",
        load_in_8bit = True,
    ...
    for epoch in range(num_epochs):
        ...
        if mean_val_loss < best_val_loss:
            ...
            if dist.get_rank() == 0:  # Ensure only rank 0 saves the model
                model.save_pretrained(os.path.join(model_save_dir, f"epoch-{epoch+1}", f"{epoch+1}_blip2_qmodel_v3.pth"))
